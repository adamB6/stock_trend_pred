...
A df of desired stock's history and it's attributes for modification
    Attributes:
        ...
        history_length       The amount of history to be pulled. i.e. '20d' for 20 days. '1y' for one year. '1m' for one month.
...
def main():
    tesla = Historydf('TSLA', '1y', 5, 1, 5)
    tesla.find_trends()
    tesla.structure_data()
    print(tesla.structured_df)
